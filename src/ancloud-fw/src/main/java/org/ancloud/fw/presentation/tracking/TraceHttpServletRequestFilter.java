...
public class TraceHttpServletRequestFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
    ...
    if(logger.isDebugEnabled()){
      ...
      MDC.put(MDC_TRACKING_ID, session.getId()+"_"+createTrackingId());
      ...
      if(request instanceof HttpServletRequest){
        ...
        requestInfo.append(String.format("[START SERVLET REQUEST] Host: %s Url: %s%s Method: %s - %s", new Object[] {
            ipAddress,
      ...
      try {
        ...
        String handlingTimeMessage = "[END SERVLET REQUEST] HANDLING TIME: {} ms";
