...
public class JwtTokenHelper implements Serializable {
	...
	private String generateAudience(HttpServletRequest request) {
...
//		}
		return agent.getDeviceCategory().getCategory().toString();
	}
	...
	public String generateToken(UserDetails userDetails, HttpServletRequest request) {
		...
		claims.put(CLAIM_KEY_AUDIENCE, generateAudience(request));
