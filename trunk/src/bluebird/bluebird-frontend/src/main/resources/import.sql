INSERT INTO bb_account(id,userName,title,password,accountNonExpired,accountNonLocked,credentialsNonExpired,enabled,createddate,updateddate) VALUES(1,'admin','Administrator','$2a$04$FQyfe75OhZGlwnm7w/R76.9xtKmLu0MZYn22oRGVMShzFKu5N0PKS',true,true,true,true,'2016-01-01 00:00:00','2016-01-01 00:00:00');
...
INSERT INTO bb_message(key, basename, language, country, variant, message) VALUES('sc.sys.00020','sc','en','US','','Member since');
...
INSERT INTO bb_message(key, basename, language, country, variant, message) VALUES('sc.account.00013','sc','en','US','','Profile');