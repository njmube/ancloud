 ...
 * code implements bluebird's functions and plugins as specified by the options
 * above.
 */
$(function() {
	"use strict";
	...
	$.bluebird.layout.activate();

	// Enable sidebar tree view controls
	$.bluebird.tree('.sidebar');

	// Enable control sidebar
	if (o.enableControlSidebar) {
		$.bluebird.controlSidebar.activate();
	}
	...
	if (o.sidebarPushMenu) {
		$.bluebird.pushMenu.activate(o.sidebarToggleSelector);
	}
 ...
 * ---------------------------------- All bluebird functions are implemented
 * below.
 */
function _init() {
	'use strict';
	 ...
	 * 
	 * @type Object @usage $.bluebird.layout.activate() $.bluebird.layout.fix()
	 * $.bluebird.layout.fixSidebar()
	 */
	$.bluebird.layout = {
		activate : function() {
			var _this = this;
	 ...
	 * 
	 * @type Object @usage $.bluebird.boxWidget.activate() Set all your options
	 * in the main $.bluebird.options object
	 */
	$.bluebird.boxWidget = {
		selectors : $.bluebird.options.boxWidgetOptions.boxWidgetSelectors,
		icons : $.bluebird.options.boxWidgetOptions.boxWidgetIcons,
		animationSpeed : $.bluebird.options.animationSpeed,
...
(function($) {
	...
	$.fn.activateBox = function() {
		$.bluebird.boxWidget.activate(this);
	};

	$.fn.toggleBox = function() {
		var button = $($.bluebird.boxWidget.selectors.collapse, this);
		$.bluebird.boxWidget.collapse(button);
	};

	$.fn.removeBox = function() {
		var button = $($.bluebird.boxWidget.selectors.remove, this);
		$.bluebird.boxWidget.remove(button);
	};
