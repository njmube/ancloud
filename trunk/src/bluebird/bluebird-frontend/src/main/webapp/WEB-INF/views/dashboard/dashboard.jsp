			...
			<div class="fc-toolbar">
				...
				<div class="fc-right">
					<div class="fc-button-group">
						<button
							type="button"
							class="fc-month-button fc-button fc-state-default fc-corner-left">month</button>
						<button
							type="button"
							class="fc-agendaWeek-button fc-button fc-state-default fc-state-active">week</button>
						<button
							type="button"
			...
			<div class="fc-view-container">
				<div class="fc-view fc-agendaWeek-view fc-agenda-view">
					<table>
								...
								<td class="fc-widget-header"><div
										...
										<table>
											<thead>
												<tr>
													<th
														class="fc-axis fc-widget-header"
														style="width: 42px;"></th>
						...
						<tbody>
							<tr>
								<td class="fc-widget-content"><div class="fc-day-grid">
										<div
													...
													<tbody>
														<tr>
															<td
																...
																style="width: 42px;"><span>all-day</span></td>
															<td
									...
									<div
										class="fc-time-grid-container fc-scroller"
										style="height: 530px;">
													...
													<tbody>
														<tr>
															<td
																...
																style="width: 42px;"><span>12am</span></td>
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>1am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>2am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>3am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>4am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>5am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>6am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>7am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>8am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>9am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>10am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>11am</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>12pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>1pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>2pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>3pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>4pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>5pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>6pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>7pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>8pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>9pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>10pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															<td
																class="fc-axis fc-time fc-widget-content"
																style="width: 42px;"><span>11pm</span></td>
															<td class="fc-widget-content"></td>
														</tr>
														<tr class="fc-minor">
															<td
														...
														<tr>
															...
															<td><div class="fc-event-container">
																	<a
																		...
																		style="border-color: rgb(0, 115, 183); top: 285px; bottom: -373px; z-index: 1; left: 0%; right: 0%; background-color: rgb(0, 115, 183);"><div
																			class="fc-content">
																			<div
																				class="fc-time"
																				data-start="6:30"
																		...
																		<div class="fc-bg"></div>
																		<div class="fc-resizer"></div></a>
																</div></td>
															<td><div class="fc-event-container">
																	<a
																		class="fc-time-grid-event fc-event fc-start fc-end fc-draggable fc-resizable"
																		style="border-color: rgb(0, 192, 239); top: 527px; bottom: -615px; z-index: 1; left: 0%; right: 0%; background-color: rgb(0, 192, 239);"><div
																			class="fc-content">
																			<div
																				class="fc-time"
																				data-start="12:00"
															...
															<td><div class="fc-event-container">
																	<a
																		class="fc-time-grid-event fc-event fc-start fc-end fc-draggable fc-resizable"
																		style="border-color: rgb(0, 166, 90); top: 835px; bottom: -989px; z-index: 1; left: 0%; right: 0%; background-color: rgb(0, 166, 90);"><div
																			class="fc-content">
																			<div
																				class="fc-time"
																				data-start="7:00"
																				data-full="7:00 PM - 10:30 PM">
															...
															<td><div class="fc-event-container">
																	<a
																		class="fc-time-grid-event fc-event fc-start fc-end fc-draggable fc-resizable"
																		style="border-color: rgb(245, 105, 84); top: 65px; bottom: -153px; z-index: 1; left: 0%; right: 0%; background-color: rgb(245, 105, 84);"><div
																			class="fc-content">
																			<div
																				class="fc-time"
																				data-start="1:30"
																			...
																			<div class="fc-title">All Day Event</div>
																		</div>
																		<div class="fc-bg"></div>
																		<div class="fc-resizer"></div></a>
																</div></td>
															<td><div class="fc-event-container"></div></td>
															<td><div class="fc-event-container"></div></td>
															<td><div class="fc-event-container"></div></td>
														</tr>
													</tbody>
