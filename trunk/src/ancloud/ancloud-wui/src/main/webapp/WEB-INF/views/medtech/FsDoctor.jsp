...
<tiles:insertDefinition name="admin">
	...
	<tiles:putAttribute name="content-body">
			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form:form modelAttribute="doctorSearchForm" cssClass="form-horizontal bb-form" action="${basePath }/med/doctor/search" method="POST">
			...
			<div class="form-group btn-group col-md-12 bb-action-group-footer">
				<div class="col-md-2">
					<button type="submit" form="doctorSearchForm" class="btn btn-primary bb-button">Search</button>
				</div>
			...
			<div class="col-md-12">
				<div class="panel panel-primary">
					...
					<c:if test="${page.totalElements > 0}">
						...
						<bb-ex:pagination formName="doctorSearchForm" page="${page }"></bb-ex:pagination>
						</c:if>
					</div>
				</div>
			</div>
