					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<ul class="list-group list-group-unbordered">
							...
							<li class="list-group-item"><b>Sex</b>
								<a class="pull-right">${patient.sex}</a>
							</li>
...
<%-- 					<a href="${basePath }/med/patient/show-info?patientId=${patient.id }" class="btn btn-info btn-block"><b>More info ...</b></a> --%>
		...
		<div class="col-md-12 col-sm-12 col-xs-12 health-analysis">
			<div class="col-md-4 col-sm-6 col-xs-12">
				<a class="info-link bg-aqua center-block" title="Tracking calendar" href="${basePath }/med/patient/tracking-calendar"><i
					class="fa fa-calendar"></i>
				</a>
				<p class="text-muted text-center">Tracking calendar</p>
			</div>
			<div class="col-md-4 col-sm-6 col-xs-12">
				<a class="info-link bg-green center-block" title="${basePath }/med/patient/charting" href="#"><i
					class="fa fa-bar-chart"></i>
				</a>
				<p class="text-muted text-center">Charting</p>
			</div>
			<div class="col-md-4 col-sm-6 col-xs-12">
				<a class="info-link bg-red center-block" title="${basePath }/med/patient/reporting" href="#">
