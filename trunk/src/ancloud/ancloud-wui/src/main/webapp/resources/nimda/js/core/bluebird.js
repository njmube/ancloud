			...
			if ($("body").hasClass("fixed")) {
				...
				if (typeof controlSidebar !== "undefined") {
					if (controlSidebar.height() > postSetWidth){
						$(".content-wrapper").css('min-height', controlSidebar.height()-$(".content-wrapper").css("marginTop")-$(".content-wrapper").css("marginBottom"));
					}
				}
			}
		},
			...
			function(e) {
				...
				if ((checkElement.is('.treeview-menu'))
					...
					checkElement.slideUp(animationSpeed, function() {
						...
						$this.find(">i:nth-child(3)").removeClass("fa-angle-left");
						$this.find(">i:nth-child(3)").addClass("fa-angle-down");
...
//							animationSpeed);
//					parent.find('a>i:nth-child(3)').removeClass('fa-angle-left')
...
//					// Get the parent li
					...
					checkElement.slideDown(animationSpeed, function() {
						...
						$this.find(">i:nth-child(3)").removeClass("fa-angle-down"); 
						$this.find(">i:nth-child(3)").addClass("fa-angle-left");
