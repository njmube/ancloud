...
<div class="bb-action-group-header btn-group bg-red">
	...
	<a href="${basePath}/${modulePath}/modify?id=${entityId}"
		class="btn bb-fa-btn fa-pencil ${empty entityId?'disabled':'' }"><spring:message code="sc.common.00002"></spring:message></a>
	<a href="${basePath}/${modulePath}/delete?id=${entityId}"
		class="btn bb-fa-btn fa-times ${empty entityId?'disabled':'' }"><spring:message code="sc.common.00003"></spring:message></a>
	<a href="${basePath}/${modulePath}/search"
		class="btn bb-fa-btn fa-search"><spring:message code="sc.common.00004"></spring:message></a>
	<a href="${basePath}/${modulePath}/search?all"
		class="btn bb-fa-btn fa-list"><spring:message code="sc.common.00005"></spring:message></a>
	<div class="btn-group">
