...
package org.bluebird.presentation.framework.factorybean;
...
@Component
public class BeanMapperContextAware extends ConfigurableMapper
		implements
	...
	public void addMapper(final Mapper<?, ?> mapper) {
		factory.classMap(mapper.getAType(), mapper.getBType()).byDefault()
				.customize((Mapper) mapper).register();
	}
}