package org.bluebird.presentation.framework.intercepter;
...
public class TraceLoggingInterceptor extends HandlerInterceptorAdapter {
	...
	public void postHandle(HttpServletRequest request,
		...
		String formattedHandlingTime = String.format("%1$,3d",
				new Object[] { Long.valueOf(handlingTime) });
	...
	protected static String buildMethodParams(HandlerMethod handlerMethod) {
		...
		List lst = new ArrayList(params.length);
