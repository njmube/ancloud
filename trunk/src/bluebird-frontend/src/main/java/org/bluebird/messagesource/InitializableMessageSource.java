...
import org.bluebird.common.util.LocaleUtils;
import org.springframework.beans.factory.InitializingBean;
import org.springframework.context.support.AbstractMessageSource;
import org.springframework.util.Assert;

public class InitializableMessageSource extends AbstractMessageSource implements
		InitializingBean {
	...
	protected boolean autoInitialize;
	 ...
	 *            -<br>
	 *            Default value is false.If message could not be resolved
	 *            returns null<br>
	 *            if set to true- will return message code if the message could
	 *            not be resolved
	 */
